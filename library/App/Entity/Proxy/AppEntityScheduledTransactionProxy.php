 ...
 */
class AppEntityScheduledTransactionProxy extends \App\Entity\ScheduledTransaction implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', '_id', '_type', '_account', '_category', '_amount', '_nextDate', '_frequency', '_continuous', '_number');
    }
